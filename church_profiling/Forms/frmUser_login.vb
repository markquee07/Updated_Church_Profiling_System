Public Class frmUser_login
    ...
    Private Sub triggerLogin()
        ...
        user_session = ua.loadUserSession(txtUsername.Text)
        With ua
            ...
            Else
                If .validateLogin() Then
                    frmMainFinal.lblUsername.Text = user_session.User_type
    ...
    Private Sub frmUser_login_Load(sender As Object, e As EventArgs) Handles MyBase.Load
